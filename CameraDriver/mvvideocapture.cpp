...
char* sFileName = "/home/newmaker-01/linuxSDK_V2.1.0.37/demo/build-QT_Demo-Desktop_Qt_5_12_2_GCC_64bit-Debug/Camera/Configs/MV-SUA133GC-Group0.config";
...
iStatus = CameraReadParameterFromFile(hCamera,sFileName);
if (iStatus!=CAMERA_STATUS_SUCCESS)
{
    perror("Error:读取失败\n");
//    return -1;
